...
public class Warrior extends Hero implements Copyable<Warrior> {
  ...
  public Warrior copy() {
    return new Warrior(name, stats.get(Attribute.MANA), stats.get(Attribute.STRENGTH), stats.get(Attribute.DEXTERITY),
